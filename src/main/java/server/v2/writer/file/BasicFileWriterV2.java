...
public class BasicFileWriterV2 implements FileWriterV2 {
    private static final DateTimeFormatter FILE_NAME_FORMAT = DateTimeFormatter.ofPattern("yyyyMMddHHmm");
    private final Writer writer;

    private BasicFileWriterV2(@NonNull Writer writer) {
        this.writer = writer;
    }

    public static BasicFileWriterV2 create(LocalDateTime localDateTime, Address address){
        ...
        return new BasicFileWriterV2(new Writer(out));
    }
